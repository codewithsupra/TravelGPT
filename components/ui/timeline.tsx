...
import { Calendar, PersonStanding, Wallet2Icon } from "lucide-react";
import {
  useMotionValueEvent,
  useScroll,
  useTransform,
    ...
    >
      <div className="max-w-7xl mx-auto py-4 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-black dark:text-white max-w-4xl">
         Your Trip Iternary from <strong className="text-primary">{ tripData.origin } to {tripData.destination}</strong> is Ready
        </h2>
